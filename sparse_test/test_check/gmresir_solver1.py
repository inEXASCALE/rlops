...
def load_data(num_train, num_test, data_dir='data_random_sparse1'):
    train_data = []
    test_data = []
    train_metrics = []
    test_metrics = []
...
def check_data_files(num_train, num_test, data_dir='data_random_sparse1'):
...
def save_data(train_data, test_data, data_dir='data_random_sparse1'):
    os.makedirs(data_dir, exist_ok=True)
...
class GMRESIR5Solver:
    ...
    def train(self, train_data, top_k=20, episodes=100, results_dir='results_random_sparse1'):
