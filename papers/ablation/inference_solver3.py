...
def visualize_precision_usage(df_precision, save_dir='inference_results'):
    ...
    # 保存图像
    save_path = os.path.join(save_dir, 'precision_usage_pies_3_ab.jpg')
    ...
    plt.tight_layout()
    save_path = os.path.join(save_dir, 'precision_usage_stacked_3_ab.jpg')
    plt.savefig(save_path, dpi=300, bbox_inches='tight', format='jpg')
    ...
    save_path = os.path.join(save_dir, 'precision_vs_condition_3_ab.jpg')
    plt.savefig(save_path, dpi=300, bbox_inches='tight', format='jpg')
    ...
    plt.tight_layout()
    save_path = os.path.join(save_dir, 'precision_combo_frequency_3_ab.jpg')
    plt.savefig(save_path, dpi=300, bbox_inches='tight', format='jpg')
...
def main():
    ...
    num_train = 100
    num_test = 100
    data_dir = 'data_random_dense3'
    model_path = 'results_random_dense3/q_tables.pkl'
    save_dir = 'inference_results3'
    ...
    logging.info("  - precision_usage_pies_3_ab.jpg: Pie charts for each stage")
    logging.info("  - precision_usage_stacked_3_ab.jpg: Stacked bar chart")
    logging.info("  - precision_vs_condition_3_ab.jpg: Precision vs condition number")
    logging.info("  - precision_combo_frequency_3_ab.jpg: Top combination frequencies")
