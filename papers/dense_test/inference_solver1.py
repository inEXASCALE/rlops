...
def visualize_precision_usage(df_precision, save_dir='inference_results'):
    ...
    # 保存图像
    save_path = os.path.join(save_dir, 'precision_usage_pies_1.jpg')
    ...
    plt.tight_layout()
    save_path = os.path.join(save_dir, 'precision_usage_stacked_1.jpg')
    plt.savefig(save_path, dpi=300, bbox_inches='tight', format='jpg')
    ...
    save_path = os.path.join(save_dir, 'precision_vs_condition_1.jpg')
    plt.savefig(save_path, dpi=300, bbox_inches='tight', format='jpg')
    ...
    plt.tight_layout()
    save_path = os.path.join(save_dir, 'precision_combo_frequency_1.jpg')
    plt.savefig(save_path, dpi=300, bbox_inches='tight', format='jpg')
...
def main():
    ...
    logging.info("  - precision_usage_pies_1.jpg: Pie charts for each stage")
    logging.info("  - precision_usage_stacked_1.jpg: Stacked bar chart")
    logging.info("  - precision_vs_condition_1.jpg: Precision vs condition number")
    logging.info("  - precision_combo_frequency_1.jpg: Top combination frequencies")
