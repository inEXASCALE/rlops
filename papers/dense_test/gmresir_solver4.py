...
def load_data(num_train, num_test, data_dir='data_random_dense4'):
    train_data = []
    test_data = []
    train_metrics = []
    test_metrics = []
...
def check_data_files(num_train, num_test, data_dir='data_random_dense4'):
...
def save_data(train_data, test_data, data_dir='data_random_dense4'):
    os.makedirs(data_dir, exist_ok=True)
...
class GMRESIR5Solver:
    ...
    def train(self, train_data, top_k=20, episodes=100, results_dir='results_random_dense4'):
...
if __name__ == "__main__":
    ...
    results_dir = 'results_random_dense4'
    ...
    if train_data is None or test_data is None:
        ...
        train_data, test_data = generate_datasets(num_train, num_test, size_range=(100, 500), kappa_range=(1, 9), verbose=True)
